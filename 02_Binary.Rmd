...
```{r}
grid <- expand.grid(
  eta = seq(0.01, 0.05, by = 0.02), 
  max_depth = seq(7, 14, by = 7),  
...
I want to acknowledge that j statistic might not be the best idea in this case. I used it so we can see our confusion table and then adjust in the future to what statistic we may desire.